...
void loop() {
  ...
  if (packetSize) {                               
    ...
    {  
      ...
      // Mueve el carrito
      case 'a':right_shift(SPEED,SPEED,SPEED,SPEED);break;
      case 'b':left_shift(SPEED,SPEED,SPEED,SPEED);break;
      case 'c':go_advance(SPEED);break;
      case 'd':go_back(SPEED);break;
      case 'e':left_turn(SPEED);break;
      case 'f':right_turn(SPEED);break;
      case 'g':left_back(SPEED);break;
      case 'h':right_back(SPEED);break;
      case 'i':clockwise(SPEED);break;
      case 'j':countclockwise(SPEED);break;
      case 'k':stop_Stop();break;
